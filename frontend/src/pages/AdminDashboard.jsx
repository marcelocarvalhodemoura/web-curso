    ...
    <div className="page admin-dashboard">
      <div className="container">
        <div className="page-header">
          <h1>Painel Admin</h1>
          <p>Progresso dos alunos na trilha</p>
        </div>

        <div className="admin-summary">
          <div className="admin-summary-card card">
            <span className="admin-summary-value">{summary.totalStudents}</span>
            <span className="admin-summary-label">Total de Alunos</span>
          </div>
          <div className="admin-summary-card card">
            <span className="admin-summary-value">{summary.activeStudents}</span>
            <span className="admin-summary-label">Alunos Ativos</span>
          </div>
          <div className="admin-summary-card card">
            <span className="admin-summary-value">{summary.avgProgress}%</span>
